...
export default function ContactPage() {
  const [state, action, pending] = useActionState<ContactIntakeState, FormData>(
    submitContactIntake,
    {}
  );
      ...
      <section className="mx-auto grid max-w-content gap-16 px-4 py-20 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8 lg:py-28">
        <div>
          ...
          <p className="mt-6 text-lg leading-8 text-brand-text">
            We support organizations operating across borders through integrated trade and
        ...
        <div className="rounded-2xl border border-brand-border bg-white p-8 shadow-soft sm:p-10">
          {state.success ? (
            <div className="space-y-6">
              ...
              <div>
                <h2 className="text-2xl font-semibold text-brand-ink">Message received</h2>
                <p className="mt-3 text-base leading-7 text-brand-text">{state.success}</p>
              </div>
