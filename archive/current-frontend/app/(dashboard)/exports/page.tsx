      ...
      <section className="mx-auto grid max-w-content gap-16 px-4 py-20 sm:px-6 lg:grid-cols-[0.85fr_1.15fr] lg:px-8 lg:py-28">
        <div>
          ...
          <h1 className="mt-5 text-4xl font-semibold tracking-tight text-brand-ink sm:text-5xl">
            Supporting Canadian Organizations Expanding Internationally
          </h1>
          <p className="mt-6 text-lg leading-8 text-brand-text">
            Tell us about your organization, target markets, and export
            objectives. Our team will review your submission and identify how
            we can support your international expansion strategy.
          </p>
          <div className="mt-10 space-y-5 text-sm leading-6 text-brand-text">
            {[
              'International expansion support tailored to each client',
              'Strategic guidance across trade remedies, market access, and ESG',
              'Advisory-led review designed to identify export opportunities'
            ].map((item) => (
        ...
        <div className="rounded-2xl border border-brand-border bg-white p-8 shadow-soft sm:p-10">
          {state.success ? (
            ...
            <form action={action} className="space-y-7">
              ...
              <div className={fieldClassName}>
                <Label htmlFor="product">What products does your organization provide?</Label>
                <Textarea
                  id="product"
                  name="product"
              ...
              <div className={fieldClassName}>
                <Label htmlFor="targetMarket">Target markets</Label>
                <Input
                  id="targetMarket"
                  name="targetMarket"
