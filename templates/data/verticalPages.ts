...
export const verticalPages: Record<string, VerticalPageData> = {
  lending: {
    ...
    audience: 'Designed for fintech founders, product teams, and operators building credit or financing products.',
    ...
    models: [
      { title: 'Direct Lending', description: 'Providing credit directly to consumers or businesses using internal or external capital.' },
      { title: 'Marketplace Lending', description: 'Connecting borrowers with lenders or investors through a platform model.' },
      { title: 'Embedded Credit', description: 'Integrating financing into platforms such as e-commerce, SaaS, or marketplaces.' },
      { title: 'Buy Now, Pay Later', description: 'Short-term installment products integrated into checkout or purchase flows.' },
      { title: 'Revenue-Based Financing', description: 'Repayment structures tied to business revenue rather than fixed schedules.' },
      { title: 'Credit Facilitation', description: 'Supporting origination, underwriting, or servicing without acting as the lender.' },
    ],
    ...
    relatedTopics: [
      insightsTopic,
      { title: fintracClusterLinks[4].title, description: fintracClusterLinks[4].description, href: fintracClusterLinks[4].href },
      { title: fintracClusterLinks[5].title, description: fintracClusterLinks[5].description, href: fintracClusterLinks[5].href },
    ],
    ctaText:
  ...
  investment: {
    ...
    audience: 'Designed for fintech teams building trading platforms, investment tools, or asset management products.',
    ...
    models: [
      { title: 'Brokerage Platforms', description: 'Enable users to buy and sell securities through self-directed accounts.' },
      { title: 'Robo-Advisors', description: 'Provide automated portfolio management based on user inputs and algorithms.' },
      { title: 'Investment Marketplaces', description: 'Connect investors with private or alternative investment opportunities.' },
      { title: 'Asset Management Tools', description: 'Support portfolio construction, monitoring, and management.' },
      { title: 'Crypto and Digital Assets', description: 'Offer access to digital asset trading, custody, or investment products.' },
      { title: 'Investment Infrastructure', description: 'Provide APIs or backend systems that enable investment functionality.' },
    ],
    regulationTitle: 'Where Regulation May Apply',
    regulationText:
    ...
    relatedTopics: [
      insightsTopic,
      { title: fintracClusterLinks[1].title, description: fintracClusterLinks[1].description, href: fintracClusterLinks[1].href },
    ],
    ctaText:
  ...
  insurance: {
    ...
    models: [
      { title: 'Digital Distribution Platforms', description: 'Enable users to compare, purchase, or manage insurance products online.' },
      { title: 'Embedded Insurance', description: 'Integrate insurance into platforms such as travel, e-commerce, or fintech products.' },
      { title: 'Brokerage and Advisory', description: 'Provide recommendations and access to insurance products.' },
      { title: 'Managing General Agents (MGAs)', description: 'Operate as intermediaries between insurers and distribution channels.' },
      { title: 'Usage-Based Insurance', description: 'Offer pricing based on behavior, data, or usage patterns.' },
      { title: 'Insurance Infrastructure', description: 'Provide technology for underwriting, claims, or policy management.' },
    ],
    regulationTitle: 'Where Regulation May Apply',
    regulationText:
  ...
  infrastructure: {
    ...
    models: [
      { title: 'Banking as a Service', description: 'Provide access to banking capabilities through partner institutions and APIs.' },
      { title: 'Payments Infrastructure', description: 'Offer tools and systems to process, route, and manage payments.' },
      { title: 'API Platforms', description: 'Enable developers to integrate financial functionality into applications.' },
      { title: 'Embedded Finance Platforms', description: 'Allow non-financial companies to offer financial products within their services.' },
      { title: 'Custody and Safekeeping', description: 'Support holding and safeguarding of financial assets.' },
      { title: 'Data and Connectivity', description: 'Enable access to financial data and system integrations.' },
    ],
    regulationTitle: 'Where Regulation May Apply',
    regulationText:
